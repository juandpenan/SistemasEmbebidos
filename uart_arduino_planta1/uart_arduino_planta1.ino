...
char uart_on_off;             // ON/OFF signal
int now = 0;                  // Time measurement
bool can_send = true;
...
void comunicationIN(){
    ...
    Serial.println('k');  // indicates the final of the reading process
}
...
void comunicationOUT(){
   ...
   Serial.println(now);  
    ...
    wait_for_ok(); // Waits until wemos finish the reading
}
